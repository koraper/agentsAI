...
description: Master Bash 자동화된 테스트 System (Bats) 위한 포괄적인 shell script 테스트. Use when writing 테스트합니다 위한 shell scripts, CI/CD pipelines, 또는 requiring test-driven development of shell utilities.
---

# Bats 테스트 Patterns

포괄적인 guidance 위한 writing 포괄적인 unit 테스트합니다 위한 shell scripts 사용하여 Bats (Bash 자동화된 테스트 System), 포함하여 test patterns, fixtures, 및 모범 사례 위한 production-grade shell 테스트.

## When 에 Use This Skill

- Writing unit 테스트합니다 위한 shell scripts
- Implementing test-driven development (TDD) 위한 scripts
- Setting up 자동화된 테스트 에서 CI/CD pipelines
- 테스트 edge cases 및 error conditions
- Validating behavior 전반에 걸쳐 different shell environments
- Building 유지 관리 가능한 test suites 위한 scripts
- Creating fixtures 위한 복잡한 test scenarios
- 테스트 multiple shell dialects (bash, sh, dash)

## Bats Fundamentals

### What is Bats?

Bats (Bash 자동화된 테스트 System) is a TAP (Test Anything Protocol) compliant 테스트 framework 위한 shell scripts that 제공합니다:
- 간단한, natural test syntax
- TAP output format compatible 와 함께 CI systems
- Fixtures 및 setup/teardown support
- Assertion helpers
...
3. **Clean up 이후 테스트합니다** - Always remove temporary files 에서 teardown
4. **Test both success 및 failure paths** - Don't just test happy path
5. **Mock external dependencies** - Isolate unit under test
6. **Use fixtures 위한 복잡한 data** - Makes 테스트합니다 more readable
7. **Run 테스트합니다 에서 CI/CD** - Catch regressions early
8. **Test 전반에 걸쳐 shell dialects** - Ensure portability
9. **Keep 테스트합니다 fast** - Run 에서 parallel when possible
10. **Document 복잡한 test setup** - Explain unusual patterns

## Resources

- **Bats GitHub**: https://github.com/bats-core/bats-core
- **Bats 문서화**: https://bats-core.readthedocs.io/
